...
## BDN KE key edge
_C.MODEL.ROI_KE_HEAD = CN()
_C.MODEL.ROI_KE_HEAD.FEATURE_EXTRACTOR = "ResNet50Conv5ROIFeatureExtractor"
_C.MODEL.ROI_KE_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_KE_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_KE_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_KE_HEAD.CONV_LAYERS = (256, 256, 256, 256)
_C.MODEL.ROI_KE_HEAD.PREDICTOR = "KERCNNC4Predictor"
_C.MODEL.ROI_KE_HEAD.POSTPROCESS_KES = False
_C.MODEL.ROI_KE_HEAD.POSTPROCESS_KES_THRESHOLD = 0.5
_C.MODEL.ROI_KE_HEAD.RESOLUTION = 14
_C.MODEL.ROI_KE_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
_C.MODEL.ROI_KE_HEAD.NUM_KES = 10
_C.MODEL.ROI_KE_HEAD.KE_WEIGHT = 1.0
_C.MODEL.ROI_KE_HEAD.NUM_MATCHTYPE = 24
_C.MODEL.ROI_KE_HEAD.MTY_WEIGHT = 1.0
_C.MODEL.ROI_KE_HEAD.RESCORING = False
_C.MODEL.ROI_KE_HEAD.RESCORING_GAMA = 0.0
