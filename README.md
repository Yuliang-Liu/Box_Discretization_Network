...
* Online demo [link](http://47.101.165.49:7002/text/demo.html). This demo uses the MLT model provided above. It can detect multi-lingual text but can only recognize English, Chinese, and most of the symbols. 
